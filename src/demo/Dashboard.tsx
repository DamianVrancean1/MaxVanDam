...
/* heatmap data — 7×12 (7 ore, 12 zile) */
const HEATMAP = Array.from({ length: 84 }, () => Math.random());
const HEATMAP_COLS = ["L", "M", "M", "J", "V", "S", "D", "L", "M", "M", "J", "V"];
